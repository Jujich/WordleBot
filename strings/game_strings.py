...
game_strings_en = {
    "rules": "Here are the rules of <b>Wordle</b>:\n\n"
             " — The main goal of the game is to guess a 5-letter word.\n"
...
game_strings_ru = {
    "rules": "Вот правила игры <b>Wordle</b>:\n\n"
             " — Цель игры - угадать слово из 5 букв.\n"
             " — После каждой попытки цвет каждой из иконок под буквой будет меняться в зависимости от того, насколько близка была Ваша догадка.\n"
             ...
             " — Вы можете посмотреть сводку своей статистики, чтобы увидеть прогресс.\n\n"
             "<i>Удачи!</i>",
    "play_start": Template(
